...
save(models, file = "0706_680Genes_7Models.RData")
...
## since ada and xgbDART did not perform well on normal tissue classificaiton
...
rocobj_models_svmLinearVa <- roc(valid.models$svmLinear$pred$obs, 
                                 valid.models$svmLinear$pred$tumor, 
                                 ci=TRUE,
                                 plot=TRUE, 
                                 legacy.axes=TRUE, percent=TRUE, 
                                 xlab="False Positive Percentage", 
...
rocobj_models_svmLinearVa <- roc(valid.models$svmRadial$pred$obs, 
                                 valid.models$svmRadial$pred$tumor, 
                                 ci=TRUE,
                                 plot=TRUE, 
                                 legacy.axes=TRUE, percent=TRUE, 
                                 xlab="False Positive Percentage", 
...
rocobj_models_svmLinearVa <- roc(valid.models$xgbDART$pred$obs, 
                                 valid.models$xgbDART$pred$tumor, 
                                 ci=TRUE,
                                 plot=TRUE, 
                                 legacy.axes=TRUE, percent=TRUE, 
                                 xlab="False Positive Percentage", 
