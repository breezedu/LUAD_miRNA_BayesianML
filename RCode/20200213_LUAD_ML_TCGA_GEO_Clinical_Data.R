...
varimp_svmLinear[1]
  ...
  sink("C:/Users/Jeff/OneDrive - QIAGEN GmbH/SVM_RFE_Prj/Jeff_Shuai/20200115_input_files/Counts/top.genes.50.txt")
  print(top.genes.50)
  sink()
...
####### 
  ...
  sink("C:/Users/Jeff/OneDrive - QIAGEN GmbH/SVM_RFE_Prj/Jeff_Shuai/20200115_input_files/Counts/top.genes.21.txt")
  print(top.genes.21)
  sink()
...
## Plot multi ROCs in one plot
  ...
  getwd()
  save.image(file = "C:/Users/Jeff/OneDrive - QIAGEN GmbH/SVM_RFE_Prj/Jeff_Shuai/20200115_input_files/workplace_7models.RData")
...
xyplot(resamples(merged.models))
