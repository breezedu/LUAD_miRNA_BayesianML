...
path <- paste0(getwd(), "/Plots0523/" )
path

PlotROCSaveJPG(rocobj_svmlinear, path, "svmLinear_tune20_train60", "svmLinear" )
...
resamps <- resamples( list(models$rf, models$knn, models$xgbDART, models$svmRadial))
summary(resamps)
